export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('gameMusic', 'assets/music/cosmic_pulse.mp3');
    this.load.audio('gameMusicAlt', 'assets/music/tranquility.mp3');

    // this.load.video('trailerVideo', 'assets/videos/trailervideo.mp4', 'loadeddata', false, true);
    
    this.load.image('menuBg', 'assets/images/hangar.jpg');
    ...
    this.load.image('weaponIconBlue', 'assets/sprites/autocannon.png');
    this.load.image('weaponIconRed', 'assets/sprites/lasergun.png');
